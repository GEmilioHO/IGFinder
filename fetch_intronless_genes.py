...
with open(f"{species}-ui_single_exon_genes.tsv", 'w', newline='') as segs_out, \
     open(f"{species}-multi_exon_genes.tsv", 'w', newline='') as megs_out, \
     open(f"{species}-intronless_genes.tsv", 'w', newline='') as igs_out:
